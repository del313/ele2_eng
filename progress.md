...
- [x] **GK Unit 1 教材重構**：已完成三頁式簡化流程 (暖身、字母、完成)，並修正 UI 邏輯。
- [ ] **GK Unit 2-8 教材部署**：將 Unit 1 的簡化模板套用至剩餘單元。
- [ ] **GK 單元視覺優化**：確保按鈕寬度一致、對齊與平板互動友善。
...
- [ ] **GK 單元教學內容簡化**：將 GK 單元轉型為「字母為主，單字為輔」的幼兒啟蒙模式，並保留影片教學。
